        ...
        <div class="cal-wrap flex flex-col">
            ...
            <div class="cal-header">
                ...
                <div class="flex items-center gap-4">
                    {{-- Tombol 'Ide Liar' Kilas Balik Video --}}
                    <button 
                        wire:click="generateTimelapse" 
                        wire:loading.attr="disabled"
                        class="flex items-center gap-2 px-3 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-[0.7rem] font-bold transition-all shadow-md active:scale-95 disabled:opacity-50"
                        title="Buat video timelapse dari foto absen bulan ini"
                    >
                        <span wire:loading.remove wire:target="generateTimelapse">🎥 KIILAS BALIK SAYA</span>
                        <span wire:loading wire:target="generateTimelapse" class="flex items-center gap-2">
            ...
            <script>
                document.addEventListener('video-ready', event => {
                    ...
                    // Opsional: Langsung pancing download otomatis
                    const a = document.createElement('a');
                    a.href = url;
                    a.download = 'KilasBalikPresensi.mp4';
