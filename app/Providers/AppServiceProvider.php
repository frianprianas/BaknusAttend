...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        \App\Models\KehadiranSiswa::created(function ($model) {
            ...
            // Determine tipe absen from keterangan field for unique subject
            $keterangan = strtolower($model->keterangan ?? '');
            $tipeLabel = str_contains($keterangan, 'pulang') ? 'Pulang' : 'Masuk';
            $uniqueSubject = "[BaknusAttend] Presensi {$tipeLabel} - {$waktu}";
            ...
            \App\Services\MailService::sendNotification(
                ...
                "<p>Halo <b>{$name}</b>,</p>
                 ...
                 <table style='width: 100%; border-collapse: collapse; margin-top: 10px;'>
                     ...
                     <tr><td style='padding: 6px 0; font-weight: bold;'>Waktu:</td><td>{$waktu} WIB</td></tr>
